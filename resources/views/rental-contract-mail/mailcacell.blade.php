...
<body>
    ...
    <div  style="background: white; width:50%; padding:2%; margin-top:2%; margin-left:25%">
        ...
        <div class="row">
            <div class="col">
                <span>Bạn đã hủy chuyến thành công trong hệ thống, tiền cọc sẽ được chuyển lại cho bạn trong vài phút. Cảm ơn bạn đã tin tưởng sử dụng dịch vụ của chúng tôi. Chúng tôi rất hân hạnh phục vụ quý khách trong nhận chuyến đi sau</span>
            </div>
        </div>
        <hr>

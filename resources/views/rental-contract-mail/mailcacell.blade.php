...
<body>
    ...
    <div  style="background: white; width:50%; padding:2%; margin-top:2%; margin-left:25%">
        ...
        <div class="row">
            <div class="col">
                <span>You have successfully canceled your trip in the system, the deposit will be returned to you in a few minutes. Thank you for using our service. We are pleased to serve you on your next trip</span>
            </div>
        </div>
        <hr>

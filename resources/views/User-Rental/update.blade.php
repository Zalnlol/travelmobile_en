  ...
  <div role="main" class="form-all" style="margin-top: 10%">
    ...
    <li class="form-line form-line-column form-col-2" data-type="control_dropdown" id="id_32">
      ...
      <li class="form-line form-line-column form-col-9" data-type="control_textbox" id="id_13">
        <label class="form-label form-label-top" id="label_13" for="rent_price"> List price </label>
    ...
    <br>
        ...
        <span style="opacity: 0.6">Suggested price: 500K/day</span>
      <br>
    <br>
    ...
    <input type="text" hidden name="lng" id="lng">
      ...
      <li class="form-line" data-type="control_checkbox" id="id_26">
        ...
        <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_5">
          <label class="form-label form-label-top" id="label_5" for="max_ship_distance"> Maximum Distance deliver </label>
          <div id="cid_5" class="form-input-wide">
        ...
        <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="id_6">
          <label class="form-label form-label-top" id="label_6" for="shipping_price_km"> Delivery rate/km </label>
          <div id="cid_6" class="form-input-wide">
        ...
        <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_6">
          <label class="form-label form-label-top" id="label_6" for="free_ship_distance"> Free deliver distance </label>
          <div id="cid_6" class="form-input-wide">
      ...
      <ul class="form-section">  
        <li class="form-line" data-type="control_checkbox" id="id_26">
          ...
          <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_5">
            <label class="form-label form-label-top" id="label_5" for="max_travel_distance"> Max daily travel distance </label>
            <div id="cid_5" class="form-input-wide">
    ...
    <ul class="form-section" id="section_41">
      ...
      <li class="form-line" data-type="control_checkbox" id="id_26">
      <label class="form-label form-label-top" id="label_24" for="input_24"> Status  </label>
      </li>
        ...
        <div id="cid_26" class="form-input-wide">
          <div class="form-single-column" role="group" aria-labelledby="label_26" data-component="checkbox">
            <span class="form-checkbox-item" style="clear:left">
              ...
              <label id="label_input_26_0" for="input_26_0"> Halt listing </label> 
            </span>
          </div>
        </div>
      </div>

      ...
      <form action="{{ route('rental.store') }}" method="post">
        ...
        <li class="form-line form-line-column form-col-9" data-type="control_textbox" id="id_13">
          ...
          <div id="cid_13" class="form-input-wide">
            <input type="text" id="rent_price" name="rent_price" data-type="input-textbox" class="form-textbox" size="20" value="" placeholder=" " data-component="textbox" aria-labelledby="label_13" /> K
          </div>
        </li>
      ...
      <div class="row">
        ...
        <ul class="form-section">
          ...
          <li class="form-line form-line-column form-col-3" data-type="control_textbox" id="id_7">
            ...
            <div id="cid_7" class="form-input-wide">
              <input type="text" id="label_7" name="address" data-type="input-textbox" class="form-textbox" size="20"/>
            </div>
          </li>
        ...
        <li class="form-line" data-type="control_textarea" style="margin-top: -20px" id="id_36">
          ...
          <div id="cid_36" class="form-input-wide">
            <textarea type="text" rows="5" id="rules" class="form-textarea" name="rules" placeholder="  Không sử dụng xe vào mục đích phi pháp. Lái xe cẩn thận, giữ xe sạch sẽ, trả xe đúng giờ. Phụ thu 500k nếu có mùi thuốc trong xe." cols="40" rows="6" ></textarea>
          </div>
        </li>

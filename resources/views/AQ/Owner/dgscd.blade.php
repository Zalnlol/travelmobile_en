        ...
        <div class="body-container faqs-detail">
            <div class="faqs-detail__sect"><a class="back-to-faqs">
                ...
                <div class="faqs-detail__wrap">
                    ...
                    <div class="content">
                        <div class="faqs">
                            <h3 class="faqs-title">2. Đánh giá sau chuyến đi</h3>
                            <div class="qa-box">
                                <div>
                                    <div>
                                        <p><i></i><span>Tôi có
                                                thể gửi đánh giá và nhận xét cho khách thuê sau chuyến đi hay
                                                không ?</span></p>
                                    </div>
                                </div>
                                <div class="answer">
                                    <p>Chủ xe có thể trực tiếp gửi đánh giá (từ 1-5*) và nhận xét đến khách
                                        thuê qua ứng dụng TravelMobile sau khi khách thuê hoàn thành chuyến
                                        đi.&nbsp;</p>
                                </div>
                            </div>
                        </div>

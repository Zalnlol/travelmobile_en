...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Thay đổi mật khẩu</div> <!--ItSolutionStuff.com-->
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('change.password') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">Xác thực mật khẩu mới</label>
